...
/**
 * Recieved message global search unit tests.
 *
 * @package     core
...
/**
 * Provides the unit tests for recieved messages global search.
 *
 * @package     core
 * @copyright   2016 Devang Gaur
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class message_recieved_search_testcase extends advanced_testcase {

    /**
     * @var string Area id
     */
    protected $messagerecievedareaid = null;
    ...
    public function setUp() {
        ...
        $this->messagerecievedareaid = \core_search\manager::generate_areaid('core_message', 'message_recieved');
     ...
     * @return void
     */
    public function test_message_recieved_indexing() {

        // Returns the instance as long as the area is supported.
        $searcharea = \core_search\manager::get_search_area($this->messagerecievedareaid);
        $this->assertInstanceOf('\core_message\search\message_recieved', $searcharea);
     ...
     * @return void
     */
    public function test_message_recieved_document() {
        ...
        $this->assertEquals($this->messagerecievedareaid . '-' . $message->id, $doc->get('id'));
     ...
     * @return void
     */
    public function test_message_recieved_access() {
        global $CFG;
