...
class coursecat implements renderable, cacheable_object, IteratorAggregate {
    ...
    public static function get($id, $strictness = MUST_EXIST, $alwaysreturnhidden = false) {
        ...
        $coursecatrecordcache = cache::make_from_params(cache_store::MODE_REQUEST, 'core', 'coursecatrecords',
                array(), array('persistent' => true, 'simplekeys' => true));
     ...
     * @return array
     */
    public static function search_courses($search, $options) {
        global $DB;
