...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2015072200.01) {
        ...
        $table->add_field('showrealidentity', XMLDB_TYPE_INTEGER, '2', null, XMLDB_NOTNULL, null, '0');
        ...
        $table->add_field('usegradebook', XMLDB_TYPE_INTEGER, '2', null, XMLDB_NOTNULL, null, '1');
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2015072200.01);
    }
