...
Y.extend(DIALOGUE, Y.Overlay, {
    // A link to the close button to make it easier to set events on later
    closebutton : null,
    ...
    initializer : function(config) {
        ...
        this.after('headerContentChange', function(e){
            ...
            if (h && !h.one('.closebutton')) {
                // The closebutton must be an anchor to ensure it can be reached from the keyboard
                this.closebutton = C('<a class="closebutton" href="#" tabIndex="0" />');
                this.closebutton.on('click', function(e) {
                    e.preventDefault();
                    this.hide(e);
                }, this);
                h.append(this.closebutton);
        ...
        switch (e.attrName) {
            case 'visible':
                ...
                if (this.get('draggable')) {
                    ...
                    this.dd.addInvalid('.closebutton');
