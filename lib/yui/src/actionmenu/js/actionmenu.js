...
ACTIONMENU.prototype = {
    ...
    initializer : function() {
        ...
        BODY.delegate('key', this.toggleMenu, 'down:enter,32', SELECTOR.MENU + ' ' + SELECTOR.TOGGLE, this);
        BODY.delegate('key', this.showIfHidden, 'down:40', SELECTOR.MENU + ' ' + SELECTOR.TOGGLE, this);
    },
    ...
    showMenu : function(e, menu) {
        ...
        this.events.push(menu.delegate('key', this.handleKeyboardEvent, 'down:9, 27', SELECTOR.MENUCHILD + ', ' + SELECTOR.TOGGLE, this));
