        ...
        setup_filter : function () {
            ...
            this.filter = new ChooserFilter({
              ...
              source: (function (container) {
                ...
                // FIXME This needs to change to this.container
                ...
                return results;
              }(this.container)), // <-- Note the parens. This invokes the function immediately.
...
'@VERSION@', {
    requires:['base', 'panel', 'moodle-core-notification', 'autocomplete-base', 'autocomplete-filters', 'event-key', 'event-valuechange', 'anim']
}
);
