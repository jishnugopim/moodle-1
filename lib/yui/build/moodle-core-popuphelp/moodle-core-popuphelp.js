...
Y.extend(POPUPHELP, Y.Base, {
    ...
    initializer: function() {
        ...
        // Check whether we should pre-load the dependencies.
        if (this.get('preventLazyLoading')) {
            Y.use('moodle-core-tooltip');
        }
    },
    ...
    ATTRS: {
        /**
         * Ensure that we load the dependencies rather than lazily loading.
         *
         * @attribute preventLazyLoading
         * @writeOnce
         * @default false
         * @type boolean
         */
...
}, '@VERSION@', {"requires": ["base-base", "base-build", "node"]});
