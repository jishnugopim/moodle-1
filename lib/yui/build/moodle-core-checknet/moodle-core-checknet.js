...
Y.extend(CheckNet, Y.Base, {
    ...
    /**
     * A reference to the check timer.
     *
     * @property checkTimer
     * @default null
     */
    ...
    _scheduleCheck: function() {
        ...
        // Schedule the next check after this._performCheck milliseconds.
        this.checkTimer = Y.later(this.get('frequency'), this, this._performCheck);
