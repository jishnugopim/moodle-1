 ...
 */
DIALOGUE = function() {
    DIALOGUE.superclass.constructor.apply(this, arguments);
};
...
Y.extend(DIALOGUE, Y.Panel, {
    ...
    hide: function(e) {
        ...
        DIALOGUE.superclass.hide.call(this, arguments);
    },
    /**
    ...
    ATTRS: {
        /**
         * Any additional classes to add to the base class.
         *
        ...
        notificationBase: {
            ...
            valueFn: function() {
                var id = this.get('id');
                var base = Y.Node.create('<div class="' + CSS.BASE + '">')
                ...
                base.addClass(this.get('additionalBaseClass'));

                Y.one(document.body).append(base);
...
Y.Base.modifyAttrs(DIALOGUE, {
    ...
    buttons: {
        ...
        valueFn: function() {
            // Use the closeButton attr to keep the stable versions API.
            if (this.get('closeButton') === false) {
                return null;
            } else {
                return [
    ...
    id: {
        writeOnce: true,
        valueFn: function() {
            return 'moodle-dialogue-' + Y.stamp(this);
        }
    },
