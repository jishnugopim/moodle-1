...
DIALOGUE = function(config) {
    ...
    if (typeof config.center === 'undefined' && typeof config.centered !== 'undefined') {
        config.center = config.centered && true || false;
    }
    delete config.centered;
...
Y.extend(DIALOGUE, Y.Panel, {
    ...
    initializer : function(config) {
        ...
        if (this.get('lockScroll') && this.get('modal')) {
            this.plug(Y.Moodle.core.LockScroll);
        }
    ...
    show : function() {
        ...
        if (this.get('lockScroll') && this.lockScroll) {
    ...
    ATTRS : {
        ...
        /**
         * Whether to lock scroll bars for this dialogue if it is modal.
         *
