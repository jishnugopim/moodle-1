...
M.atto_image = M.atto_image || {
    ...
    init: function(params) {
        ...
        M.atto_image._button = M.editor_atto.add_toolbar_button(params.elementid, 'image', iconurl, params.group, M.atto_image.displayDialogue, this);
    },

    /**
     * Display the image picker dialogue.
     *
    ...
    displayDialogue: function(e, elementid) {
        ...
        if (M.atto_image.selection !== false) {
            if (!dialogue) {
                M.atto_image.dialogue = dialogue = new M.core.dialogue({
                    headerContent: M.util.get_string('createimage', 'atto_image'),
                    visible: false,
                    render: true,
                    modal: true,
                    close: true,
            ...
            // the focus will be changed to the editor itself.
            dialogue.setAttrs({
                    bodyContent: M.atto_image.get_form_content(elementid),
                    focusAfterHide: M.atto_image._button
                });
    ...
    set_image : function(e, elementid) {
        ...
        M.atto_image.dialogue.set('focusAfterHide', M.editor_atto.get_editable_node(elementid))
                .hide();
