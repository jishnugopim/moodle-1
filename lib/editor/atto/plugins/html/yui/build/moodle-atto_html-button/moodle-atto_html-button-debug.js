...
Y.namespace('M.atto_html').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    _showHTML: function() {
        ...
        if (!this.get('isHTML')) {
            ...
            host.textarea.set('value',
                    M.core.beautify.html_beautify(host.textarea.get('value'), {
                        indent_size: 2,
            ...
            this.editor.hide();
            if (!this._codeMirror) {
                this._codeMirror = M.core.codemirror.fromTextArea(host.textarea.getDOMNode(), {
                    lineNumbers: true,
                    mode: 'htmlmixed',
                    tabSize: 2
                });
    ...
    "requires": [
        ...
        "moodle-core-beautify",
        "moodle-core-codemirror",
        "event-valuechange"
    ]
});
