 ...
 */
function AttoBackColor() {
    AttoBackColor.superclass.constructor.apply(this, arguments);
}

Y.namespace('M.atto_backcolor').Button = Y.extend(AttoBackColor, Y.M.editor_atto.EditorPlugin, {
