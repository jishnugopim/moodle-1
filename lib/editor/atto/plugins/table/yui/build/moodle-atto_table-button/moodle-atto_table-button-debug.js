...
Y.namespace('M.atto_table').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    _getEditDialogueContent: function() {
        ...
        this._content = Y.Node.create(template({
                ...
                edit: true,
                nonedit: false,
                appearance: this.get('allowStyling'),
                allowBorder: this.get('allowBorder'),
                allowBorderStyle: this.get('allowBorderStyle'),
                borderStyles: this.get('borderStyles'),
                allowBorderSize: this.get('allowBorderSize'),
                allowBorderColours: this.get('allowBorderColours'),
    ...
    ATTRS: {
        ...
        allowStyling: {
            readOnly: true,
            getter: function() {
                return this.get('allowBorder') || this.get('allowBackgroundColour') || this.get('allowWidth');
            }
        }
    }
});
