...
Y.namespace('M.atto_table').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    _getDialogueContent: function(edit) {
        ...
        this._content.one('#id_message_atto_table_borders').on('change', this._updateAvailableSettings, this);
    ...
    _updateAvailableSettings: function() {
        var tableForm = this._content,
            enableBorders = tableForm.one('#id_message_atto_table_borders'),
            borderStyle     = tableForm.one('#id_message_atto_table_borderstyle'),
            borderSize      = tableForm.one('#id_message_atto_table_bordersize'),
