...
Feature: Atto tables
  ...
  Scenario: Create a table with background colour and width with border settings off
    ...
    | config | value | plugin |
    | allowborder | 0 | atto_table |
    | allowborderstyle | 0 | atto_table |
    ...
    And I set the field "Background Hex" to "#000"
    ...
    Then I should see "style=\"background-color:#000;width:100%;\""
  ...
  Scenario: Edit a table with background colour and width with border settings off
    ...
    And I click on "Show more buttons" "button"
    And I click on "HTML" "button"
    Then I should see "style=\"width:100%;background-color:rgb(0,0,0);\""

  @javascript
  Scenario: Create a table with background colour and width with borders on
    Given the following config values are set as admin:
    | config | value | plugin |
    | allowborder | 1 | atto_table |
    | allowborderstyle | 0 | atto_table |
    | allowbordersize | 0 | atto_table |
    | allowbordercolour | 0 | atto_table |
    | allowbackgroundcolour | 1 | atto_table |
    ...
    And I click on "Show more buttons" "button"
    And I click on "HTML" "button"
    Then I should see "style=\"border:1px solid #FFFFFF;background-color:#000;width:100%;\""
  ...
  Scenario: Edit a table with background colour and width with borders on
    ...
    And I click on "Show more buttons" "button"
    And I click on "HTML" "button"
    Then I should see "style=\"border:1px solid rgb(255,255,255);width:100%;background-color:rgb(0,0,0);\""
  ...
  Scenario: Create a table with background colour and width with borders and border styling on
    ...
    And I click on "Show more buttons" "button"
    And I click on "HTML" "button"
    Then I should see "style=\"border:1px dashed #FFFFFF;background-color:#000;width:100%;\""
  ...
  Scenario: Edit a table with background colour and width with borders and border styling on
    ...
    And I click on "Show more buttons" "button"
    And I click on "HTML" "button"
    Then I should see "style=\"border:1px dashed rgb(255,255,255);width:100%;background-color:rgb(0,0,0);\""
  ...
  Scenario: Create a table with background colour and width with borders, border styling, and border size on
    ...
    And I click on "Show more buttons" "button"
    And I click on "HTML" "button"
    Then I should see "style=\"border:2px dashed #FFFFFF;background-color:#000;width:100%;\""
  ...
  Scenario: Edit a table with background colour and width with borders, border styling, and border size on
    ...
    And I click on "Show more buttons" "button"
    And I click on "HTML" "button"
    Then I should see "style=\"border:2px dashed rgb(255,255,255);width:100%;background-color:rgb(0,0,0);\""
  ...
  Scenario: Create a table with all settings on
    ...
    And I set the field "Style of borders" to "dashed"
    And I set the field "Size of borders" to "2"
    And I set the field "Border Colour Hex" to "#000"
    And I press "Create table"
    And I press "Save changes"
    And I follow "Edit"
    And I click on "Show more buttons" "button"
    And I click on "HTML" "button"
    Then I should see "style=\"border:2px dashed #000;background-color:#000;width:100%;\""
  ...
  Scenario: Edit a table with background colour and width with borders, border styling, and border size on
    ...
    And I click on "Show more buttons" "button"
    And I click on "HTML" "button"
    Then I should see "style=\"border:2px dashed rgb(0,0,0);width:100%;background-color:rgb(0,0,0);\""
