...
M.editor_atto = M.editor_atto || {
     ...
     * @return boolean Whether the specified plugin is enabled.
     */
     ...
     *
     * @method add_text_updated_handler
     * @param {string} elementid the id of the textarea we created this editor from.
     * @param {function} callback The function to perform following an update.
     */
     ...
     * @param {string} groupname the group the button should be appended to.
     * @param {Function} handler A function to call when the button is clicked.
     */
     ...
     * @return bool Whether the cursor is currently active in the editor instance.
     */
     ...
     *
     * @method get_selection_from_node
     * @param {Node} yui node for the selection
     * @return {Range} A browser-dependent range object.
     */
     ...
     *
     * @method get_selection_parent_node
     * @return DOMObject
     */
     ...
     * @param {mixed} selection TODO Document me.
     */
