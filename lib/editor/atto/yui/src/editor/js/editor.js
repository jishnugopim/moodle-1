...
Y.extend(Editor, Y.Base, {
    ...
    setupChangeHandlers: function() {
        ...
        this.editorEvents.push(
            ...
            atto.on('focus', this.restoreSelection, this),
    ...
    isActive: function() {
        ...
        return node && this.editor.contains(node);
    },
    ...
    getCleanHTML: function() {
        ...
        return this.cleanHTML().editor.get('innerHTML');
    },
    ...
    cleanHTML: function() {
        ...
        return this.editor.set('innerHTML', this._cleanHTML(startValue));
    },
     ...
     */
    getSelection_parent_node: function() {
        var selection = this.getSelection();
        if (selection.length) {
            selection = selection.pop();
        }
    ...
    formatSelectionBlock: function(blocktag, attributes) {
        ...
        var selectionparentnode = this.getSelection_parent_node(),
            boundary,
            cell,
            nearestblock,
            newcontent,
...
Y.namespace('this').Editor = Editor;
