...
Y.extend(Editor, Y.Base, {
    ...
    initializer: function() {
        ...
        YUI.M.editor_atto.addEditorReference(this.get('elementid'), this);
    ...
    destructor: function() {
        ...
        YUI.M.editor_atto.removeEditorReference(this.get('elementid'), this);
    },
...
Y.namespace('M.editor_atto.Editor').init = function(config) {
    Y.log("Y.M.editor_atto.Editor.init has been deprecated since Moodle 2.9." +
            "Please use YUI.M.editor_atto.createEditor instead", "warn", LOGNAME);
    return YUI.M.editor_atto.createEditor(config);
};
// This file is part of Moodle - http://moodle.org/
//
// Moodle is free software: you can redistribute it and/or modify
...
EditorAutosave.prototype = {
    ...
    setupAutosave: function() {
        ...
        this._registerEventHandle(this.textarea.ancestor('form').on('submit', this.resetAutosave, this));
        return this;
    },
...
EditorSelection.prototype = {
    ...
    setupSelectionWatchers: function() {
        ...
        this._registerEventHandle(this.on('atto:selectionchanged', this.saveSelection, this));
