...
EditorPluginButtons.prototype = {
    ...
    _showToolbarMenu: function(e, config) {
        ...
        if (!this.menus[config.buttonClass]) {
            ...
            this._buttonHandlers.push(
                menu.delegate('click', this._chooseMenuItem, '.atto_menuentry a', this, config, this.menus[config.buttonClass]),
                menu.delegate('key', this._chooseMenuItem, '32, enter', '.atto_menuentry', this, config, this.menus[config.buttonClass])
            );
        }
