...
Y.extend(EditorPlugin, Y.Base, {
     ...
     *
     * This passes through to {{#crossLink M.editor_atto.updateOriginal}}updateOriginal{{/crossLink}}.
     *
     * @method markUpdated
     */
...
EditorPluginButtons.prototype = {
     ...
     *
     * Possible states are 
     * {{#crossLink "M.editor_atto.EditorPlugin/ENABLED:property"}}{{/crossLink}}, or
     * {{#crossLink "M.editor_atto.EditorPlugin/DISABLED:property"}}{{/crossLink}}.
     *
     ...
     * button when any match is good enough. See {{#crossLink "M.editor_atto.Editor/selectionFilterMatches:method"}}{{/crossLink}} for more information.
    ...
    _showToolbarMenu: function(e, config) {
        ...
        if (!this.menus[config.buttonClass]) {
            ...
            this._buttonHandlers.push(
                ...
                menu.delegate('key', this.menuKeyboardNavigation, 'down:38,40', '.menu', this),
     ...
     *
     * @method menuKeyboardNavigation
     * @param {EventFacade} e - the keyboard event.
     */
    menuKeyboardNavigation: function(e) {
