...
/**
 * This code bas been deprecated and will be removed from Moodle 2.6
 *
...
M.util.help_icon = {
    ...
    add : function(Y, properties) {
        if (M.cfg.developerdebug) {
            Y.log("You are using a deprecated function call (M.util.help_icon.add). Please look at rewriting your call to support lib/yui/popuphelp/popuphelp.js");
        }
        this.Y = Y;
