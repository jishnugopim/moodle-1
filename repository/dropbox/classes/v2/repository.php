 ...
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class repository extends \repository_dropbox_base {
     ...
     *
     * @param   string      $id         The file path or file id of the file to fetch a thumbnail for.
     */
    public function send_thumbnail($id) {
        ...
        send_file($content, basename($id), 30 * DAYSECS, 0, true);
    }
     ...
     *
     * @param string $packed the content of files.reference field or result of
    ...
    public function get_file($packed, $saveas = '') {
        ...
        $downloadlink = $this->get_file_download_link($reference->url);
     ...
     *
     * @param   string  $packed     The result of get_file_reference()
     * @return  string
     */
    ...
    public function send_file($storedfile, $lifetime=null , $filter=0, $forcedownload=false, array $options = null) {
        ...
        if ($maxcachesize = empty($this->max_cache_bytes())) {
