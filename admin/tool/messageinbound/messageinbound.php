...
$PAGE->set_url('/admin/tool/messageinbound/messageinbound.php');
$PAGE->set_context(context_system::instance());
$PAGE->set_pagelayout('admin');
$strheading = get_string('messageinbound', 'tool_messageinbound');
...
if (empty($classname)) {
    ...
    echo $OUTPUT->header();
    echo $OUTPUT->heading(get_string('editinghandler', 'tool_messageinbound', $handler->classname));
