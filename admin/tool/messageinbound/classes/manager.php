...
class manager {
     ...
     *
     * @param $maildata The data retrieved from the database for the current record.
     ...
     * @param $skipsenderverification Whether to skip the sender * verificiation stage
     */
    public function process_message(
        ...
        foreach ($recipients as $recipient) {
            ...
            if (!$ignoreseen && $this->message_has_flag($messageid, self::MESSAGE_SEEN)) {
            ...
            $this->currentmessagedata = $this->process_message_data($message, $envelope, $messagedata, $messageid);
            ...
            $this->process_message_data_body($message, $messagedata, $messageid);
     ...
     */
    private function inform_user_of_error(
            $error) {
        global $DB, $USER;
