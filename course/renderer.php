...
class core_course_renderer extends plugin_renderer_base {
    ...
    protected function coursecat_tree(coursecat_helper $chelper, $coursecat) {
        ...
        $content .= html_writer::tag('div', $categorycontent, array('class' => 'content'));
            ...
            $content .= html_writer::tag('div', get_string('collapseall'), array('class' => 'addtoall collapseall'));
            $content .= html_writer::tag('div', get_string('expandall'), array('class' => 'removefromall expandall'));
            $content .= html_writer::end_tag('div');
