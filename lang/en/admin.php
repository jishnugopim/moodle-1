...
$string['configopentoadcrawlers'] = 'If you enable this setting, then Advertising crawlers will be allowed to enter your site as a Guest.  This will improve targetted advertising based on site content.  Note that this only provides transparent access to courses that already allow guest access.';
...
$string['opentoadcrawlers'] = 'Open to Ad crawlers';
