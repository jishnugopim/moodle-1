...
$string['followforcelogin'] = 'Respect forcelogin';
$string['forcelogin'] = 'Force users to log in';
$string['forceloginforprofileimage'] = 'Force users to log in to view user pictures';
$string['forceloginforprofileimage_help'] = 'If enabled, users must log in in order to view user profile pictures and the default user picture will be used in all notification emails. Note: Guests are prevented from viewing profile images in this case too.';
