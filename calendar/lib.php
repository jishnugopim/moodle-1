...
function calendar_get_mini($courses, $groups, $users, $calmonth = false, $calyear = false, $placement = false,
    ...
    $content .= '<table id="' . $id . '" class="minicalendar calendartable" summary="'.$summary.'">'; // Begin table.
    ...
    $PAGE->requires->yui_module('moodle-calendar-info', 'Y.M.calendar.info.init', array(array('calendarNode' => $id)));
    return $content;
}
