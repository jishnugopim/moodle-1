...
var ROWFIELDS = 'th.user, th.userreport, th.userfield, .gradebook-user-cell',
    COLFIELDS = 'tr[data-column] th.item, .gradebook-header-cell';
...
Highlighter.prototype = {
    ...
    _highlightColumn: function(e) {
        ...
        this.graderRegion.all('td.cell[data-column="' + column + '"]').toggleClass(COLMARK);
    },
    ...
    _handleScrollEvent: function() {
        ...
        if (this.footerRow) {
            ...
            if (Y.config.win.pageYOffset + Y.config.win.innerHeight - 40 < this.footerRowPosition) {
                ...
                if (Y.config.win.pageYOffset + Y.config.win.innerHeight - 40 > this.firstUserCellBottom) {
                    // The footer is above the bottom of the frist user
