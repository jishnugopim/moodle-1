...
$string['check_adcrawlers_details'] = '<p>The Open to Ad Crawlers setting enables advertising engines to enter courses with guest access. There is no point in enabling this setting if guest login is not allowed.</p>';
$string['check_adcrawlers_error'] = 'Ad crawler engine access is allowed but guest access is disabled.';
$string['check_adcrawlers_info'] = 'Ad crawler engines may enter as guests.';
$string['check_adcrawlers_name'] = 'Open to Ad crawlers';
$string['check_adcrawlers_ok'] = 'Search engine access is not enabled.';
