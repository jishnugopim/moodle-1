...
$string['trackingtypestandard'] = 'Read tracking';
...
$string['trackingtypestandard_help'] = 'If enabled, participants can track read and unread posts in the forum and in discussions. There are two options:
