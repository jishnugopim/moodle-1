...
class mod_scorm_lib_testcase extends externallib_advanced_testcase {
    ...
    public function test_scorm_check_and_require_available() {
        ...
        // Usual case.
        list($status, $warnings) = scorm_check_available($this->scorm, false);
        ...
        list($status, $warnings) = scorm_check_available($this->scorm, true, $this->context);
        $this->assertEquals(false, $status);
        $this->assertCount(2, $warnings);
