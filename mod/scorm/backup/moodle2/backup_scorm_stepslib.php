...
class backup_scorm_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        // Order is important for several SCORM calls (especially scorm_scoes) the following calls to set_source_table
        $sco->set_source_table('scorm_scores', array('scorm' => backup::VAR_PARENTID), 'id ASC');
